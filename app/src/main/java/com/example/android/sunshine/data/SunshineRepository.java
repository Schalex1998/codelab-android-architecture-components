...
public class SunshineRepository {
    ...
    private boolean isFetchNeeded() {
        return mWeatherDao.countAllFutureWeather(SunshineDateUtils.getNormalizedUtcDateForToday()) < WeatherNetworkDataSource.NUM_DAYS;
    }
    ...
    public LiveData<List<ListWeatherEntry>> getCurrentForecasts() {
        initializeData();
        return mWeatherDao.getWeathersAfterDate(SunshineDateUtils.getNormalizedUtcDateForToday());
    }
